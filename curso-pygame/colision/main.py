import pygame 
from rectangulo_pequeño import 
from rectangulo_pequeño import
...
while running:
    ...
    pos_anterior_pequeno = rectagulo_pequeno.obtener_posicion()
    pos_anterior_grande = rectagulo_grande.obtener_posicion()
